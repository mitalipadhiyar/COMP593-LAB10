...
def main():
    image_date = download_image('https://images.pexels.com/photos/45201/kitty-cat-kitten-pet-4')
    result = save_image_file(image_date, r'C:\temp\kitty.jpg')
    return
...
def download_image(image_url):
    ...
    # Check if the image was retrived sucessfully
